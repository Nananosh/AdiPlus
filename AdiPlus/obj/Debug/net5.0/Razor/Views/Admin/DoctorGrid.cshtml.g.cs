#pragma checksum "F:\Education\Poliklinika2\AdiPlus\AdiPlus\Views\Admin\DoctorGrid.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2963aa45ee45c74391532bc819297cf8766f3a47"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2963aa45ee45c74391532bc819297cf8766f3a47", @"/Views/Admin/DoctorGrid.cshtml")]
...
#nullable disable
   ...
   ");
    ...
    function specializationEditor(container, options) {
        $('<input required name=""SpecializationId"" data-bind=""value:' + options.field + '""/>')
                .appendTo(container)
                .kendoDropDownList({
...
#nullable disable
    ...
    function cabinetEditor(container, options) {
        $('<input required name=""CabinetId"" data-bind=""value:' + options.field + '""/>')
                .appendTo(container)
                .kendoDropDownList({
                    ...
                    dataSource: {
                        transport: {
                            read: {
                                url: """);
#nullable restore
#line 117 "F:\Education\Poliklinika2\AdiPlus\AdiPlus\Views\Admin\DoctorGrid.cshtml"
